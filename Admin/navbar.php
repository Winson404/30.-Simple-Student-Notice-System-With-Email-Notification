...
<head>
  ...
  <title>Student Notice System</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="../images/login.png" alt="BMSLogo" height="105" width="105">
  </div> 
...
?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.php" class="brand-link">
      <img src="../images/login.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Student Notice</span>
      <!-- <br>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-4">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           <a href="loggedrecords.php" class="nav-link"><i class="fa-solid fa-paperclip"></i><p>&nbsp;&nbsp; Log records</p></a>
          </li>
